...
import { FaCheckCircle, FaChevronDown, FaEdit, FaEllipsisV, FaPlusCircle } from "react-icons/fa";
      ...
      <div className="container mt-3">
        <div className="d-flex justify-content-between mb-3">
          ...
          <div className="float-end">
            <button className="btn btn-outline-secondary ml-2 me-2"><FaPlusCircle /> Group</button>
            <button className="btn btn-red ml-2 me-2"><FaPlusCircle /> Assignment</button>
